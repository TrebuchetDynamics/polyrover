...
| CLOB               | Books, prices, single/batch price history, builder trades, rebates, token fee rates, and market metadata                | `clob.polymarket.com`                                                                                                  | HTTPS       | none       | `public`      | implemented | [`src/api/clob.rs`](../src/api/clob.rs)                                 | [`tests/client.rs`](../tests/client.rs)                                                          |
...
| Data API           | Positions, paginated closed positions/trades/activity/combo activity, filtered leaderboards, and builder volume history | `data-api.polymarket.com`                                                                                              | HTTPS       | none       | `public`      | implemented | [`src/api/data.rs`](../src/api/data.rs)                                 | [`tests/client.rs`](../tests/client.rs), [`tests/contracts.rs`](../tests/contracts.rs)           |
...
| CLOB builder trades      | `GET /builder/trades`          | none | `Client::builder_trades`          | SDK only                        | opaque cursor, builder, ID, market, asset, time filters | one page                | `tests/client.rs`                                                 | [Builder trades](https://docs.polymarket.com/api-reference/trade/get-builder-trades)                            |
| CLOB rebates             | `GET /rebates/current`         | none | `Client::rebates`                 | SDK only                        | date and maker address                                  | one request             | `tests/client.rs`                                                 | [Current maker rebates](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker) |
...
| Data combo activity      | `GET /v1/activity/combos`      | none | `Client::combo_activity`          | SDK only                        | cursor, offset, wallet, and market filters              | one page                | `tests/client.rs`                                                 | [Combo activity](https://docs.polymarket.com/api-reference/core/get-user-combo-activity)                        |
...
| User rewards page         | `GET /rewards/user`         | CLOB             | HTTPS     | L2         | `authenticated` | implemented | [`src/api/authenticated_clob.rs`](../src/api/authenticated_clob.rs) | [`tests/authenticated_client.rs`](../tests/authenticated_client.rs)                                                |
| User rewards total        | `GET /rewards/user/total`   | CLOB             | HTTPS     | L2         | `authenticated` | implemented | [`src/api/authenticated_clob.rs`](../src/api/authenticated_clob.rs) | [`tests/authenticated_client.rs`](../tests/authenticated_client.rs)                                                |
| User reward markets       | `GET /rewards/user/markets` | CLOB             | HTTPS     | L2         | `authenticated` | implemented | [`src/api/authenticated_clob.rs`](../src/api/authenticated_clob.rs) | [`tests/authenticated_client.rs`](../tests/authenticated_client.rs)                                                |

Authenticated history is library-only. Each method borrows `&L2Credentials`, signs the canonical path without query parameters, and returns one response/page or one order. `ClientConfig` and the cloneable `Client` contain no credentials. Polyrover provides no authenticated CLI or live credential canary, and adds no API-key creation, private-key signing, order mutation, traversal, or persistence.
...
- [Authenticated order lookup](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id)
- [Data combo activity](https://docs.polymarket.com/api-reference/core/get-user-combo-activity)
- [Prediction Markets API reference](https://docs.polymarket.com/api-reference/predictions/overview)
- [CLOB market WebSocket channel](https://docs.polymarket.com/api-reference/wss/market)
