...
| CLOB builder trades      | `GET /builder/trades`          | none | `Client::builder_trades`          | SDK only                        | opaque cursor, builder, ID, market, asset, time filters | one page                | `tests/client.rs`                                                 | [API reference](https://docs.polymarket.com/api-reference)                                                   |
| CLOB rebates             | `GET /rebates/current`         | none | `Client::rebates`                 | SDK only                        | date and maker address                                  | one request             | `tests/client.rs`                                                 | [API reference](https://docs.polymarket.com/api-reference)                                                   |
...
- [Prediction Markets API reference](https://docs.polymarket.com/api-reference)
